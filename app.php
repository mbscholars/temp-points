...
Route::prefix('api/v1')->group(function(){
    ...
    Route::post('registration/duplicate-email-check', 'RegisterController@checkUserRegistrationEmail');
    Route::post('registration/duplicate-phone-number-check', 'RegisterController@registerDuplicatePhoneNumberCheck');

    /**
     *  AUTHENTICATED USER - DASHBOARD
     */
    Route::group(['middleware' => ['check-authorization-token']], function ()//bug-fixed-pm-v2.7
    {
